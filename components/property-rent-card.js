...
const PropertyRentCard = ({ imageDimensions }) => {
  return (
    <Link
      className="cursor-pointer [text-decoration:none] flex-1 rounded-3xs bg-gray-white box-border h-[467px] flex flex-col items-start justify-start py-[15px] px-[13px] gap-[23px] min-w-[355px] max-w-[400px] text-left text-mini-5 text-gray-700 font-body-regular-600 border-[1px] border-solid border-whitesmoke-200 hover:bg-gainsboro hover:cursor-pointer sm:w-[100%!important] sm:mb-5"
      href="/"
    >
      <img
