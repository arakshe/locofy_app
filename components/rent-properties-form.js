import PropertyRentCardd from "./property-rent-cardd";
    ...
    <div className="self-stretch flex flex-col items-center justify-start py-[86px] px-0 gap-[39px] text-center text-21xl text-primary-800 font-body-regular-600">
      <div className="self-stretch flex flex-col items-center justify-start gap-[40px] max-w-[95%]">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[40px] text-left text-base text-gray-white">
          <PropertyRentCardd propBackgroundImage="url('/card-11@3x.png')" />
          <PropertyRentCardd propBackgroundImage="url('/card-21@3x.png')" />
          <PropertyRentCardd propBackgroundImage="url('/card-31@3x.png')" />
          <PropertyRentCardd propBackgroundImage="url('/card-41@3x.png')" />
        </div>
      </div>
